...
export namespace hello {
    ...
    export abstract class UnimplementedHelloGrpcService {
        static definition = {
            SayHello: {
                path: "/hello.HelloGrpc/SayHello",
                requestStream: false,
    ...
    export class HelloGrpcClient extends grpc_1.makeGenericClientConstructor(UnimplementedHelloGrpcService.definition, "HelloGrpc", {}) {
